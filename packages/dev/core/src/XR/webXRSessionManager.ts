...
export class WebXRSessionManager implements IDisposable, IWebXRRenderTargetTextureProvider {
    ...
    constructor(sceneOrEngine: Scene | Engine) {
        if (sceneOrEngine instanceof Scene) {
            ...
            this.engine = sceneOrEngine.getEngine() as Engine;
        ...
        this._onEngineDisposedObserver = this.engine.onDisposeObservable.addOnce(() => {
            this.engine = null;
        });
    }
        ...
        this.engine.customAnimationFrameRequester = {
            ...
            renderFunction: (timestamp: number, xrFrame: Nullable<XRFrame>) => {
                ...
                if (xrFrame) {
                    ...
                    if (this.engine.framebufferDimensionsObject !== framebufferDimensionsObject) {
                        this.engine.framebufferDimensionsObject = framebufferDimensionsObject;
                    }
